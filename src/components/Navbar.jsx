...
import { Timeline, Power2, Back } from "gsap/gsap-core";
...
const Navbar = () => {
  ...
  return (
    <section
      className={navColor ? "header active" : "header"}
      ref={rootRef}
    >
      <div className="wrapper header__wrapper">
        <nav className="header__nav">
          <a href="/" className="header__home header__nav-icon">
            bhishanmahat
          </a>
